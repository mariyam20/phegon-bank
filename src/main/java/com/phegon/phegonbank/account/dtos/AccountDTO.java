...
public class AccountDTO {
    ...
    @JsonBackReference// this will not be added to the account dto. It will be ignored because it is a back refrence ifnired
    ...
    @JsonManagedReference// if help avoid recursion loop by ignoring the AccountDTO withing the AccountDTO
